        ...
        <div className="max-w-6xl mx-auto">
          ...
          <header className="mb-24">
            <div className="flex items-center gap-4 mb-8 opacity-40">
               <span className="font-mono text-[10px] tracking-[0.5em] uppercase">Structural Case Study // 0{projects.indexOf(project) + 1}</span>
               <div className="flex-1 h-px bg-foreground" />
            </div>
            
            <h1 className="project-title text-6xl md:text-9xl font-bold tracking-tighter mb-12 overflow-hidden leading-[0.85] text-balance">
              {project.title.split(' ').map((word, i) => (
                i === 1 ? <span key={i} className="font-serif italic font-light opacity-60"> {word} </span> : word
              ))}
            </h1>
