...
import { ArrowRight, Briefcase, GraduationCap, Award, Mail, Layout, Compass } from "lucide-react"
  ...
  return (
    <div className="py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="nav-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {navCards.map((card) => (
            <Link
              key={card.name}
              href={card.href}
