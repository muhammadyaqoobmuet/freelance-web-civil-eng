    ...
    <section ref={container} className="relative min-h-[90vh] flex flex-col justify-center items-center px-6 pt-24 overflow-hidden">
      ...
      <div className="max-w-5xl w-full relative z-10 flex flex-col md:flex-row items-center md:items-center justify-center gap-8 sm:gap-12 md:gap-20">
        ...
        <div className="hero-avatar relative">
          ...
          <div className="relative w-40 h-40 xs:w-48 xs:h-48 md:w-72 md:h-72 rounded-[2.5rem] overflow-hidden border border-foreground/10 bg-muted/20 backdrop-blur-sm shadow-xl">
            <Image 
        ...
        <div className="hero-text-content flex flex-col items-center md:items-start text-center md:text-left space-y-6 md:space-y-8 max-w-xl">
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-secondary/60 font-mono text-[9px] md:text-[10px] uppercase tracking-[0.2em] md:tracking-[0.25em]">
          ...
          <p className="text-base sm:text-lg md:text-xl text-secondary font-light leading-relaxed px-2 md:px-0">
          ...
          {/* Quick Contact Bar */}
          <div className="flex items-center gap-4 md:gap-6 pt-4 border-t border-foreground/5 w-full justify-center md:justify-start">
            <button 
              onClick={copyEmail}
